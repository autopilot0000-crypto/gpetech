    ...
    bm: [
        {
            ...
            icon: <RobotIcon />,
            image: "/images/feature-robot-auto.png",
        },
        {
            ...
            icon: <ZeroRiskIcon />,
            image: "/images/feature-zero-risk.png",
        },
        {
            ...
            icon: <ProfitLockIcon />,
            image: "/images/feature-profit-lock.png",
        },
        {
            ...
            image: "/images/feature-smart-layering.png",
        },
        {
            title: "Spread Filter",
            ...
            image: "/images/feature-spread-filter.png",
        },
        {
            ...
            icon: <AutoTrendIcon />,
            image: "/images/feature-trend-reversal.png",
        },
        {
            ...
            image: "/images/feature-news-protection.png",
        },
        {
            ...
            image: "/images/feature-manual-panel.png",
        },
        {
            ...
            icon: <BonusGuideIcon />,
            image: "/images/feature-bonus-guide.png",
        },
    ],
    en: [
        {
...
const DetailedFeatures: React.FC = () => {
  ...
  return (
    <section id="detailed-features" className="py-20 bg-pirus-dark overflow-hidden">
      <div className="container mx-auto px-6">
        ...
        <div className="space-y-24">
          {features.map((feature, index) => {
            const imageName = feature.image.split('/').pop();
            return (
              <div key={index} className={`grid lg:grid-cols-2 gap-12 items-center`}>
                <div className={`relative ${index % 2 === 0 ? 'lg:order-last' : ''}`}>
                  <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full bg-gradient-to-tr ${index % 2 === 0 ? 'from-pirus-blue/20' : 'from-pirus-pink/20'} to-transparent blur-3xl opacity-40`}></div>
                  <img 
                      src={feature.image} 
                      alt={`${feature.title}. Expected file: ${imageName}`}
                      className="w-full h-auto object-contain rounded-lg shadow-2xl shadow-pirus-dark/50 relative z-10"
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-pirus-light mb-6">{feature.description}</p>
