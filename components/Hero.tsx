...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative bg-pirus-dark pt-24 pb-20 lg:pt-32 lg:pb-28 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
                ...
                <p className="mt-6 max-w-xl mx-auto lg:mx-0 text-lg text-pirus-light">
                    {t.subtitle}
                </p>
            ...
            <div className="hidden lg:block">
                <img src="/images/hero-dashboard.png" alt="Automated Trading Dashboard" className="w-full h-auto object-cover rounded-lg shadow-2xl shadow-pirus-blue/10"/>
            </div>
        </div>
      </div>
    </section>
